...
urlpatterns = patterns('',
    ...
    url(r'^password_reset/$', 'mail_factory.contrib.auth.views.password_reset'),
    url(r'^password_reset/(?P<uidb36>[0-9A-Za-z]{1,13})-(?P<token>[0-9A-Za-z]{1,13}-'r'[0-9A-Za-z]{1,20})/$', 'django.contrib.auth.views.password_reset_confirm'),
